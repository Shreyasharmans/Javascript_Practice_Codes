//1>>Reduce
let arr= new Array(1,2,3,4) //1*2*3*4=24
let res=arr.reduce((a,b)=>a*b);
console.log(res); 

res=arr.reduce((a,b)=>a+b,5); //5 is initial value=5+4+3+2+1
...
let resultCC = words.map((word)=>word[0].toUpperCase()+word.slice(1)).join(".");
